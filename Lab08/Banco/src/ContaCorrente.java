...
public class ContaCorrente {
     ...
     */
    public void transferir(float valor, ContaCorrente contaDestino) throws TransferenciaDeValorNaoPositivo, SaldoInsuficienteException {
        // valida o parâmetro
        if (valor <= 0) {
            throw new TransferenciaDeValorNaoPositivo();
        }
