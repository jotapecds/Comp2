...
public class ContaCorrenteTest {
    ...
    public void testarSaqueComValorNegativo() {
        ...
        // o valor deve permanecer o mesmo pois a operação é inválida
        assertEquals(10f, contaMaria.getSaldoEmReais(), ERRO_ACEITAVEL_NOS_FLOATS);
    }

    @Test
    public void testarSaqueComValorSuperiorAoSaldoTotal() {
        Pessoa maria = new Pessoa("Maria", 12345678);
        Agencia minhaAgencia = new Agencia();
    ...
    @Test
    public void testarSaqueComValorValido() {
        Pessoa maria = new Pessoa("Maria", 12345678);
        Agencia minhaAgencia = new Agencia();
        ...
        // o valor deve permanecer o mesmo pois a operação é inválida
        assertEquals(2f, contaMaria.getSaldoEmReais(), ERRO_ACEITAVEL_NOS_FLOATS);
    }
}